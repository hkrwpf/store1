...
att1 = MIMEText(open(r"D:\ruanjiandakai\自动化测试\autoweb03\test\hkr.html", 'rb').read(), 'base64', 'utf-8')
att1["Content-Type"] = 'application/octet-stream'
att1["Content-Disposition"] = 'attachment; filename = "test.html"'
msg.attach(att1)

att2 = MIMEText(open(r"D:\ruanjiandakai\自动化测试\autoweb03\test\gai.html", 'rb').read(), 'base64', 'utf-8')
